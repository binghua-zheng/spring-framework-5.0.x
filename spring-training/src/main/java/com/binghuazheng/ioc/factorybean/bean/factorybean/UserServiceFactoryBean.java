package com.binghuazheng.ioc.factorybean.bean.factorybean;

import com.binghuazheng.ioc.factorybean.bean.UserService;
import com.binghuazheng.ioc.factorybean.bean.impl.UserServiceImpl;
...
/**
 * @ClassName UserServiceFactoryBean
 * @Description TODO
 ...
 */
@Component
public class UserServiceFactoryBean implements SmartFactoryBean {
	/**
